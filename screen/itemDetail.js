    ...
    return (
        <Container style={{ backgroundColor: COLORS.light }}>
            ...
            <Content>
                ...
                <View style={{ margin: 5 }}>
                    <Text style={{ fontWeight: 'bold', fontSize: 35 }}>{item.itemName}</Text>
            ...
            <View style={{ ...styles.totCard }}>
                ...
                <View style={{ marginVertical: 10, marginRight: 20, backgroundColor: '#fff' }}>
                    <Button small style={{ alignSelf: 'flex-end', ...styles.cardButton }}
                        onPress={() => addcart(item.itemId, Total, item.itemName, Quantity)}
                    >
